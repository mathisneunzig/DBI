...
\begin{frame}
  ...
  These rules are based on mutual respect. The expectation is not perfection but honest communication. Ifsomething is not working for you, say so early rather than letting it become a bigger problem.
\end{frame}
